...
struct ArtworkPrintable {
  var name: String
  var medium: String
  var availability: ArtworkAvailablility
  var date: String
  
  func printArtworkSubtitle(artwork: ArtworkPrintable) {
    print(artwork.name)
    print(artwork.date)
  }
}
//: done. Ish. This still works fine. We can see this by doing:
var discoP = ArtworkPrintable(name: "Death Disco", medium: "Oil on Panel", availability: .NotForSale, date: "2004")
discoP.printArtworkSubtitle(discoP)
